...
router.post('/login', redirectHome, async (req, res, next) => {
  ...
  if (username && password) {
    ...
    if (password && adminUser.length) {
      ...
      res.render('admin/auth', { err: 'T\'es en train d\'écrire n\'importe quoi...' });
    }
  } else {
    res.render('admin/auth', { err: 'Merci de bien vouloir remplir le formulaire !' });
  }
